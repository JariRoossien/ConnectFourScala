...
class EasyAIButton(connectFourGame: ConnectFourGame) extends Button {
    ...
    override def onClick(): Unit = {
        connectFourGame.currentScene = new BoardGameScene(new GameInstance(connectFourGame, true, 2))
    ...
    override def getImage(): PImage = connectFourGame.imageProvider.get("easyAIButton")
}
